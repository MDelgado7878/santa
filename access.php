...
<body>
    <script src="./js/onlyNumbersLetters.js"></script>
        ...
        <div class="card">
            ...
            <form action="controller/client.php" method="post">
                <div class="inputContainer mt-5">
                    ...
                    <div class="inpt">
                        <input autocomplete="off" class="input-element" id="client" maxlength="8" type="password" name="pass">
                    </div>
    ...
    <script>
        ...
        /* Hacer que el input solo acepte numeros y letras */
        var out = '';
        var filter = 'abcdefghijklmnñopqrstuvwxyzABCDEFGHIJKLMNÑOPQRSTUVWXYZ1234567890';
        input.addEventListener('keyup', () => {
            for (var i = 0; i < input.value.length; i++)
                if (filter.indexOf(input.value.charAt(i)) != -1)
