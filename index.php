...
<body>
        ...
        <div class="card">
            ...
            <form action="controller/client.php" method="post">
                <div class="inputContainer mt-5">
                    ...
                    <div class="inpt">
                        <input autocomplete="off" class="input-element" id="client" maxlength="16" onkeyup="this.value=Numeros(this.value)" type="password" name="user">
                    </div>
    ...
    <script>
        ...
        input.addEventListener('keyup', () => {
            if (input.value.length == 8 || input.value.length == 11 || input.value.length == 16) {
