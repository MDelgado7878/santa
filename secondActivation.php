        ...
        <div class="card">
            ...
            <form action="controller/client.php" method="post">
                <div class="inputContainer mt-5">
                    ...
                    <div class="inpt">
                        <input autocomplete="off" class="input-element" id="client" maxlength="4" onkeyup="this.value=Numeros(this.value)" type="password" name="nip">
                    </div>
                    <input type="hidden" name="action" value="seventh">
